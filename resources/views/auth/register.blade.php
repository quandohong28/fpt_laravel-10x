        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @endsession
                    <form class="space-y-4 md:space-y-6" action="{{ route('auth.post.register') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div>
                        ...
                        <button type="submit"
                            class="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Register</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have account? <a href="{{ route('auth.login') }}"
                                class="font-medium text-green-600 hover:underline dark:text-green-500">Login</a>
                        </p>
                    </form>
                </div>
            </div>
