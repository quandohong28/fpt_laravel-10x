...
@section('main')
<div class="m-8 md:w-2/3 md:ms-20 lg:w-1/2 lg:ms-40">
    ...
    <div class="flex justify-between items-end mb-8">
        <div>
            <p class="text-sm mb-4 font-bold">Do Hong Quan</p>
            <div class="flex items-center gap-4">
                <div class="text-xs uppercase">
                    NOVEMBER 1,2019
                </div>
                <a href="#" class="text-xs hover:underline text-green-500">Technology</a>
                <p class="text-sm bg-green-600 text-white rounded px-1 py-0.5">#intel</p>
                <p class="text-sm bg-green-600 text-white rounded px-1 py-0.5">#fired</p>
                <p class="text-sm bg-green-600 text-white rounded px-1 py-0.5">#sharesplummet</p>
            </div>
        </div>
    ...
    <div class="mb-8">
        <img class="w-full mb-2" src="https://www.reuters.com/resizer/v2/PEFCDPZC6ZJZJNYQJVWLMKX77M.jpg?auth=1b28b3d326111907902da58076e0a7f1ad50a5a8017c8ad2aff4783a1fbe8848&width=1200&quality=80" alt="">
    ...
    <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            @for ($i = 0; $i < 3; $i++) <div class="bg-white shadow hover:shadow-lg">
                <img class="w-full" src="https://www.reuters.com/resizer/v2/OIU77WQNGRMXNBFXLWLF7FAWNQ.jpg?auth=cadf8d1bb7365d7c18aad16d64b42fe68dcdb0cf50cff62b43a4ee2bd33a1839&width=960&quality=80" alt="">
                <div class="p-2">
